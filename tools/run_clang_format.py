...
Taken from https://github.com/Sarcasm/run-clang-format with the following changes:
- Changed - to _ in the filename
...
# Dynamic build the regex
SOURCE_FILE_REGEX = r"(\w.*.(" + DEFAULT_EXTENSIONS.replace(
    ',', '|').replace('+', '\+') + r"))"
...
def main():
    ...
    # Keep track of the files that need to be changed
    files_require_changes = []
