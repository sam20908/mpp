      ...
      <div>
        ...
        <MDBContainer className="mt-5">
          ...
          <MDBTypography tag="p" className="lead mt-3">
            <b>mpp</b> strives to mimic STL-style interface with algorithms and
            operations declared outside of the matrix class to allow users to
            &quot;Pay For What You Use&quot;. The API was also designed to be
            compatible with standard STL algorithms, which means it meets the
            C++ Named Requirements for whatever operation it supports{" "}
            ...
            Lastly, <b>mpp</b> is designed to be widely customizable, with the
            help of <b>customization point objects</b> to allow customizing all
            algorithms and operations in the library for certain user-defined
            types.
          </MDBTypography>
          <br />
        ...
        <MDBContainer className="mt-5">
          ...
          <MDBTypography tag="p" className="lead mt-5">
            ...
            It allows customization of all <b>mpp customization points</b> in
            one function name, which reduces the chance of someone being
            confused. Here is another example with another utility function:
          </MDBTypography>
          <CodeBlock code={customize_utilities} theme={theme} />
          <MDBTypography tag="p" className="lead mt-5">
            mpp also uses custom iterators that meets the Standard iterator
            requirements <b>(LegacyContiguousIterator)</b> with extra
