...
namespace mpp
{
	...
	struct block_t : public detail::cpo_base<block_t>
	{
		template<typename Value,
			std::size_t RowsExtent,
			std::size_t ColumnsExtent,
			detail::constant_or_assignable_to_size_t TopRowIndex,
			detail::constant_or_assignable_to_size_t TopColumnIndex,
			detail::constant_or_assignable_to_size_t BottomRowIndex,
			detail::constant_or_assignable_to_size_t BottomColumnIndex,
			typename Allocator,
