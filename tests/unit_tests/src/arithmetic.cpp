...
namespace
{
	TEST(Arithmetic, Addition_SameSizedOperands)
	{
	...
	TEST(Arithmetic, Addition_DifferentSizedOperands_Throw)
	{
	...
	TEST(Arithmetic, Subtraction_SameSizedOperands)
	{
	...
	TEST(Arithmetic, Subtraction_DifferentSizedOperands_Throw)
	{
		auto matrix1 = matrixpp::matrix<int>{ { 7, 3, 1 }, { 8, 8, 2 }, { 5, 8, 2 }, { 6, 7, 8 } };
		auto matrix2 = matrixpp::matrix<int>{ { 7, 3, 1 }, { 8, 8, 2 }, { 5, 8, 2 } };
		EXPECT_THROW((void)(matrix1 - matrix2), std::runtime_error);
	...
	TEST(Arithmetic, Multiplication_ScalarXMatrix)
	{
		auto matrix = matrixpp::matrix<int>{ { 7, 3, 1 }, { 8, 8, 2 }, { 5, 8, 2 } };
		auto expr   = 2 * matrix;
	...
	TEST(Arithmetic, Multiplication_MatrixXMatrix_MultipliableMatrices)
	{
		auto matrix = matrixpp::matrix<int, 3, 3>{ { 7, 3, 1 }, { 8, 8, 2 }, { 5, 8, 2 } };
		auto expr   = matrix * matrix;
